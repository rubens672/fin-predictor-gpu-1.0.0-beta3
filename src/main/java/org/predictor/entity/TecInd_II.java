...
@Entity
@Table(name="TEC_IND_II")
public class TecInd_II implements Serializable {
	...
	public TecInd_II(Date data, String timestamp, String symbol, String indType, double valI, double valII, int intervalMin) {
		this.data = data;
